...
require('top.php');
?>
<div class="ht__bradcaump__area" style=" background: url(images/slider/bg/background.jpg) no-repeat scroll center center / cover;">
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="address">
                            ...
                            <div class="address__details">
                                ...
                                <p>Suryadatta Institute of Managament</p>
                            </div>
                        </div>
