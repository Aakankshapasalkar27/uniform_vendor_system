...
$meta_title="Uniform Vendor System";
$meta_desc="Uniform Vendor System";
$meta_keyword="Uniform Vendor System";
$meta_url=SITE_PATH;
$meta_image="";
                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo"style="width:200px;margin-left:-50px;">
                                     <a href="index.php"><img src="images/logo/Final1_Logo.png" alt="logo images"></a>
                                </div>
                            </div>
                                              ...
                                              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                                <ul class="navbar-nav mr-auto">
                                                  <li class="nav-item dropdown">
                                                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Welcome <?php echo $_SESSION['USER_NAME']?></a>
                        ...
                        <div class="col-md-12">
                            <!-- <div class="search__inner">
                                <form action="search.php" method="get">
                                    <input placeholder="Search for products...." type="text" name="str">
