...
if(isset($_POST['submit'])){
    ...
    $contacts=get_safe_value($con,$_POST['contacts']);
    ...
    mysqli_query($con,"insert into `order`(user_id,address,city,pincode,contacts,payment_type,payment_status,order_status,added_on,total_price,txnid,coupon_id,coupon_code,coupon_value) values('$user_id','$address','$city','$pincode','$contacts','$payment_type','$payment_status','$order_status','$added_on','$total_price','$txnid','$coupon_id','$coupon_code','$coupon_value')");
                                    ...
                                    <div class="accordion__body">
                                        <div class="bilinfo">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="single-input">
<input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="contacts" Placeholder="Contact number*" required>
                                                        </div>
                                                    </div>
                                                </div>
                                        </div>
                                    ...
                                    <div class="accordion__body">
                                        <div class="paymentinfo">
                                            <div class="single-method">
                                                <input type="radio" name="payment_type" value="COD"/ required>   COD &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="Payu_method" type="radio" name="payment_type" value="payu"/ required>  Pay Online 
                                            </div>
                                            <div class="single-method">
                    ...
                    <div class="col-md-4">
                        <div class="order-details">
                            ...
                            <!-- <div class="ordre-details__total" id="coupon_box">
                                <h5>Coupon Value &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="price" id="coupon_price"></span></h5>
                            </div> -->
