                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <p>Thanks for buying Uniform. This is an invoice for your purchase.</p>
	                            ...
	                            if($coupon_value!=''){
            						$html.='<tr>
			                                  <td width="80%" class="purchase_footer" valign="middle">
			                                    <p class="f-fallback purchase_total purchase_total--label">Coupon discount</p>
			                                  </td>
                ...
                <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="content-cell" align="center">
                      <p class="f-fallback sub align-center">All rights reserved by SIBMT & SIMMC</p>
                      <p class="f-fallback sub align-center">
                        Uniform Vendor System
                        <br>Suryadatta Institute of Business Management & Technology
                        <br>Bavdhan
                      </p>
                    </td>
                  </tr>
