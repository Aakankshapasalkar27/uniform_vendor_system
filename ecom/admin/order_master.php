               ...
               <div class="row">
                  <div class="col-xl-12">
                     <div class="card">
                        ...
                        <button type="button" class="btn btn-outline-primary"><a style="color:black;" href="all_order_pdf.php">Generate Report</a></button>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="product-add-to-cart"><a href="order_master_detail.php?id=<?php echo $row['id'] ?>"><?php echo $row['id'] ?></a>
                         <a href="../order_pdf.php?id=<?php echo $row['id']?>">Order Report</a></td>
                        </td>
