...
?>
  <!-- Start Bradcaump area -->
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/bg/8.jpg) no-repeat scroll center center / cover ;">
                        ...
                        <div class="contact-form-wrap mt--60">
                            <div class="col-xs-12">
                                <div class="contact-title">
                                    <h2 class="title__line--6">Password Recovery</h2>
                                </div>
                            </div>
                            <div class="col-xs-12">
